...
import { ButtonToolbar, Button, Col, Input, Row, Modal } from 'react-bootstrap';
              ...
              <Row className="full">
                <Col className="toolbar" xs={12}>
                  <ButtonToolbar>
                    ...
                    <Button value="#" onClick={this._handleInsertAtEnd}><i className="fa fa-header">1</i></Button>
                    <Button value="##" onClick={this._handleInsertAtEnd}><i className="fa fa-header">2</i></Button>
                    <Button value="###" onClick={this._handleInsertAtEnd}><i className="fa fa-header">3</i></Button>
                    <Button value="####" onClick={this._handleInsertAtEnd}><i className="fa fa-header">4</i></Button>
              ...
              <Row className="full"> 
                ...
                <Col className="editor-col" xs={6}>
                 <Input
                  ...
                  type='textarea'
                  placeholder={ attribute.element.default }
                ...
                <Col className="preview-col" onClick={this._handleShowEditor} xs={12}>
                  <div className="markdown-preview" dangerouslySetInnerHTML={ MarkdownUtil.renderDangerouslyInnerHtml(attribute.value == "" ? "**Click here to write the content**" : attribute.value) }>
                  </div>
                </Col>
              </Row>
            </div>
            ...
            <div className="fullscreen-editor">
              ...
              <Row className="editor-row"> 
                ...
                <Col className="preview-col" xs={6}>
                  <div className="markdown-preview" dangerouslySetInnerHTML={ MarkdownUtil.renderDangerouslyInnerHtml(attribute.value) }>
                  </div>
                </Col>
              </Row>
